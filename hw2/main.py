...
def run_agents():
    ...
    parser.add_argument('agent0', type=str, default='alphabeta',
                        help='First agent')
    parser.add_argument('agent1', type=str, default='greedy',
                        help='Second agent')
    ...
    parser.add_argument('-c', '--count_steps', nargs='?', type=int, help='Number of steps each robot gets before game is over',
                        default=200)
    parser.add_argument('--console_print', action='store_true', default=False)
    ...
    if not args.tournament:
        ...
        for step in range(args.count_steps):
